...
// convolve
Ext.CLIJ_copy("blobs.gif", "convolved");
...
newImage("psfEstimate", "32-bit black", 25, 25, 1);
Ext.CLIJ_push("psfEstimate");

Ext.CLIJ_blindDeconvolve("convolved", "psfEstimate", "blindDeconvolved", 10, 1);

Ext.CLIJ_pull("blindDeconvolved");
